...
if __name__ == "__main__":
    ...
    subdir = Path("/NAS5/speech/user/richamishra/champ/data/motions/motion-01/images")
    if subdir.is_dir():
    ...
    gpu_id = args.device
    image_paths = glob(os.path.join("/NAS5/speech/user/richamishra/champ/data/motions/motion-01/images","*.png"))
